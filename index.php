    ...
    <style>
        *{
        ...
        .container{
            ...
            background-image: url(./offline_assets/images/background.png);
        }
    ...
    <div uk-height-viewport="offset-top: true" class="container uk-width-large uk-background-cover uk-margin-auto"  uk-img>
        ...
        <div class="share-container uk-flex uk-flex-center uk-margin-large-top">
            ...
            <!-- <div class="uk-margin-left">
                <a target="_blank" href="<?php echo ($facebook_link_head . $share_link); ?>">
                    <img class="blocktouch uk-width-expand" src="./offline_assets/images/facebook.png" alt="">
                </a>
            </div> -->

            <!-- Whatsapp Share -->
            <!-- <div class="uk-margin-left">
                <a target="_blank" href="<?php echo ($whatsapp_link_head . $share_link); ?>">
                    <img class="blocktouch uk-width-expand" src="./offline_assets/images/whatsapp.png" alt="">
                </a>
            </div> -->

            <!-- Wechat Share -->
            <!-- <div class="uk-margin-left">
                <a target="_blank" href="<?php echo ($wechat_link_head . $share_link); ?>">
                    <img class="blocktouch uk-width-expand" src="./offline_assets/images/wechat.png" alt="">
                </a>
            </div> -->

            <!-- Navigator Share -->
            <!-- <div class="uk-margin-left uk-link" onclick="sharebtn()">
                <img class="blocktouch uk-width-expand" src="./offline_assets/images/share.png" alt="">
            </div> -->
        </div>
